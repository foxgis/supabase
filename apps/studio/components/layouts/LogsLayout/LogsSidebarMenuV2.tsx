...
export function LogsSidebarMenuV2() {
  ...
  return (
    <div className="pb-12 relative">
      ...
      {collectionsEnabled && (
        <>
          <SidebarCollapsible title="日志集合" defaultOpen={true}>
          ...
          {OPERATIONAL_COLLECTIONS.length > 0 && (
            <>
              <Separator className="my-4" />
              <SidebarCollapsible title="数据库操作" defaultOpen={true}>
      ...
      <SidebarCollapsible title="查询" defaultOpen={true}>
        {savedQueriesLoading && (
          <div className="p-4">

      ...
      <div className="mx-2 flex items-center gap-2">
        ...
        {showSavedText ? (
          <Tooltip_Shadcn_>
            ...
            <TooltipContent_Shadcn_ side="bottom">所有变更已保存</TooltipContent_Shadcn_>
          </Tooltip_Shadcn_>
          ...
          <Tooltip_Shadcn_>
            ...
            <TooltipContent_Shadcn_>正在保存变更...</TooltipContent_Shadcn_>
          </Tooltip_Shadcn_>
          ...
          isSnippetOwner ? (
            <Tooltip_Shadcn_>
              ...
              <TooltipContent_Shadcn_>保存变更失败</TooltipContent_Shadcn_>
            </Tooltip_Shadcn_>
          ) : (
            <ReadOnlyBadge id={id} />
          )
